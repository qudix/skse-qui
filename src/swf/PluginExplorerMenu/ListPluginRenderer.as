class PluginExplorerMenu.ListPluginRenderer extends gfx.controls.ListItemRenderer
{
	/* PRIVATE VARIABLES */
	...
	public var indexContainer: MovieClip;
	public var textContainer: MovieClip;
	public var countContainer: MovieClip;

	public function ListPluginRenderer(a_data: Object) { super(); }

	private function updateInfo(): Void
	{
		if (data != null) {
			var dataIndex: String = data.index != null ? data.index : "??";
			var dataName: String = data.name != null ? data.name : "<Unknown>";
			var dataCount: Number = data.count != null ? data.count : 0;

			indexContainer.textField.text = dataIndex;
			indexContainer.textField.textColor = WHITE;
